...
# ES6,ES7新特性
    1.定义:let,const
    2.解构,扩展运算符,Promise,模板字符串,module,Class,for-of,Map,Set,箭头函数
    3.对象:Object.is(),Object.assign(),Object.key(),Object.value(),Object.getOwnPropertyNames(),Object.entries()
    ...
    4.数组:forEach,filter,map,reduce,every,some,fill,from,isArray,find,findIndex,includes
